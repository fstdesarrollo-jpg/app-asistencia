...
app.post('/api/madres', async (req, res) => {
    ...
    const id = randomUUID();
    await pool.query(`INSERT INTO madres (id, nombre_completo, documento, municipio, numero_equipo, coordinacion)
     VALUES (?, ?, ?, ?, ?, ?)`, [id, data.nombreCompleto, data.documento, data.municipio, data.numeroEquipo, data.coordinacion]);
